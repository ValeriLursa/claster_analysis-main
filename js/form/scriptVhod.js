...
"Тема 5. Состав первоначального компьютера","Тема 6. Устройства ввода-вывода","Тема 7. Программное обеспечение компьютера"];
var dataVhodSelect = [];
var dataProvColor = [];
var dataVhodSelect1 = [];
...
function vhod(numberTest) {
	switch (numberTest) {
		case testName[0]:
			...
			resultProvColor = new resultColor();
			rootArray = ['<b>информ</b> ация', 'с <b>бор</b>', 'со <b>xран</b> ять', 'об <b>рабат</b> ывать', '<b>реш</b> ать', 'вы <b>числ</b> ение', 'об <b id="word6">работ</b> ка', '<b id="word7">xран</b> ение', '<b id="word8">информ</b> ационный', '<b id="word9">реш</b> ение', 'вы <b id="word10">числ</b> ять', 'об <b id="word11">работ</b> анный', '<b id="word12">xран</b> ить', '<b id="word13">информ</b> атика', 'со <b id="word14">бир</b> ать', 'со <b id="word15">xран</b> ение']
			startWordColor = ['информация', 'сбор', 'соxранять', 'обрабатывать', 'решать', 'вычисление', 'обработка', 'xранение', 'информационный', 'решение', 'вычислять', 'обработанный', 'xранить', 'информатика', 'собирать', 'соxранение']
			...
			numTextZad = 7;
			var dataProvDetailedAnswer0 = ["Условие задачи представляет собой исходную информацию.",
				"Математические вычисления представляют собой обработку исходной информации.",
				"Информатика представляет собой науку о сборе, хранении и обработке информации."];
